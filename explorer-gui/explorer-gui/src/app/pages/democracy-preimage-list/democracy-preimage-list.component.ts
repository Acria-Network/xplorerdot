 ...
 *
 * democracy-preimage-list.component.ts
 */
...
export class DemocracyPreimageListComponent implements OnInit, OnDestroy {

  public preimages: DocumentCollection<DemocracyPreimage>;
  currentPage = 1;
  ...
  getItems(page: number): void {
    ...
    this.democracyPreimageService.all(params).subscribe(preimages => {
